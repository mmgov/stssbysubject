...
my_doc <- my_doc %>% 
  body_add_par("J. History", style = "Section Header")
...
main <- subset(stss, `Q3`== 'History')

sec <- subset(stss, `Q4` == 'History' )
...
my_doc <- my_doc %>% 
  body_add_par("Chart J1 Academic sessions (XX respondents)", style = "Normal") %>% 
...
my_doc <- my_doc %>% 
  body_add_par("Chart J2 The academic staff (XX respondents)", style = "Normal") %>% 
  body_add_img(src = src, width = 6,  height = 3)
...
my_doc <- my_doc %>% 
  body_add_par("Chart J3 The group project sessions (XX respondents)", style = "Normal") %>% 
  body_add_img(src = src, width = 6,  height = 3)
...
my_doc <- my_doc %>% 
  body_add_par("Chart J4 Overall, how would you rate the Sutton Trust Summer school at UoE? (XX respondents)", style = "Normal") %>%
...
my_doc <- my_doc %>% 
  body_add_par("Chart J5 Overall, are you more or less likely to consider applying to ANY university now? (XX respondents)", style = "Normal") %>%
  body_add_img(src = src, width = 6,  height = 3, style = "Normal")
...
my_doc <- my_doc %>% 
  body_add_par("Chart J6 Overall, are you more or less likely to consider applying to UoE now? (XX respondents)", style = "Normal") %>%
  body_add_img(src = src, width = 6, height = 3, style = "Normal")
