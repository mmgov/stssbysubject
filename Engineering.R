...
my_doc <- my_doc %>% 
  body_add_par("D. Engineering", style = "Section Header")
...
main <- subset(stss, `Q3`== 'Engineering')

sec <- subset(stss, `Q4` == 'Engineering' )
...
my_doc <- my_doc %>% 
  body_add_par("Chart D1 Academic sessions (XX respondents)", style = "Normal") %>% 
...
my_doc <- my_doc %>% 
  body_add_par("Chart D2 The academic staff (XX respondents)", style = "Normal") %>% 
  body_add_img(src = src, width = 6,  height = 3)
...
my_doc <- my_doc %>% 
  body_add_par("Chart D3 The group project sessions (XX respondents)", style = "Normal") %>% 
  body_add_img(src = src, width = 6,  height = 3)
...
my_doc <- my_doc %>% 
  body_add_par("Chart D4 Overall, how would you rate the Sutton Trust Summer school at UoE? (XX respondents)", style = "Normal") %>%
...
my_doc <- my_doc %>% 
  body_add_par("Chart D5 Overall, are you more or less likely to consider applying to ANY university now? (XX respondents)", style = "Normal") %>%
  body_add_img(src = src, width = 6,  height = 3, style = "Normal")
...
my_doc <- my_doc %>% 
  body_add_par("Chart D6 Overall, are you more or less likely to consider applying to UoE now? (XX respondents)", style = "Normal") %>%
  body_add_img(src = src, width = 6, height = 3, style = "Normal")
